namespace V3SaveManagerGUI.Editors
{
	partial class FilesEditor
	{
		...
		private void InitializeComponent()
		{
			...
			// FileInfoWRDFile
			// 
			FileInfoWRDFile.Location = new Point(12, 89);
			...
			// FileInfoTextArchive
			// 
			FileInfoTextArchive.Location = new Point(12, 166);
			...
			// FileInfoTextSTX
			// 
			FileInfoTextSTX.Location = new Point(12, 243);
			...
			// FileInfoWRDMap
			// 
			FileInfoWRDMap.Location = new Point(12, 320);
			...
			// 
			FileInfoSubroutineWRD.Location = new Point(322, 89);
			...
			// 
			FileInfoSubroutineTextArchive.Location = new Point(322, 166);
			...
			// 
			FileInfoSubroutineSTX.Location = new Point(322, 243);
			...
			// SetButton
			// 
			SetButton.Location = new Point(478, 362);
			...
			// ResetButton
			// 
			ResetButton.Location = new Point(322, 362);
